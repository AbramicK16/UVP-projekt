...
class Zajec:
    def __init__(self, teza, starost):
        self.teza = teza #self.teza = nalepka, teza = spremenljivka
        self.starost = starost
        print("Zdaj smo ustvarili novo živo bitje.")
...
#     5.6
# =============================================================================
class Zajec(Zajec): #nadgradimo zgornjega zajca
...
def uredi(teze, starosti):
    ...
    for i in range(len(teze)):
        zajci.append(Zajec(teze[i], starosti[i]))
        zajci.sort() #uredimo po velikosti
    return zajci
